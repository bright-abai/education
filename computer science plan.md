...
| #   | Creativity                                                                         | Programming                                   | Physicality                                                            | OS&Collaboration                                              |
| --- | ---------------------------------------------------------------------------------- | --------------------------------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------- |
| 5   | storytelling through text and images(obsidian)                                     | linear python with mathematics                | arduino lights with ready made code and curcuits, basic hardware parts | emails, logins, password, edupage                             |
| 6   | GIMP Krita raster drawing, Figma Inkskape vector drawing, visual novels with RenPy | python conditionals and loops                 | arduino curcuits with premade code, extended hardware                  | google docs, sheets, slides and forms                         |
| 7   | Audacity music, sounds, social media posts                                         | python functions, algorithms, problem solving | arduino code, hardware maintance and characteristics                   | Files, operating systems overview, permissions, cybersecurity |
| 8   | Blender 3D modeling, texturing and sculpting                                       | python in blender                             | 3d printing, projects, robots                                          | File formats, sheets advanced, OS maintance and manipulation  |
| 9   | Game development and design, interactive storytelling with RenPy, animation        | Java OOP patterns, GUI, Minecraft modding     | 3d printing, projects, robots and hardware maintance                   | Project management, Agile framworks                           |
| 10  | Website design and making, html/css/js, Graphical design and color theory, UI/UX   | Rust, systems programming                     | Networks, routers, cabels                                              | Server management, github, ssh, remote collaboration, docker  |
| 11  | Portfolio development, peer critique and public presentation                       | Computer science algorithms and theory        | Machine learning and AI, computer vision and IoT                       | Cybersecurity, data privacy and licenses, open-source         |
