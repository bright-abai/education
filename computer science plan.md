...
| --- | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| 5   | storytelling through Office tools, team collaboration, finding or generating images | microsoft office or alternatives basics (perhaps without Excel), GUIs, following instructions, Arduino simple lights | 1.1 binary system basics, vs code, files, logins, passwords                                    |
| 6   | GIMP Krita raster drawing, Figma Inkskape vector drawing, visual novels with RenPy  | Pseudocode syntax, basic algorithms, attention to details. Basic Arduino curcuits                                    | 1.2, 3, 6, 8 data representation of text and images, basic hardware description                |
| 7   | Audacity music, sounds, social media posts, video montage                           | Python with maths, conditionals and loops, some libraries, perhaps TKinter                                           | 1.2, 1.3, 2, 4, 5 data representation of sound and videos, data storage and Internet, software |
